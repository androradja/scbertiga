...
import com.musicapps.tubidyeaskekuli.databinding.ItemSong2Binding;

import java.util.ArrayList;
import java.util.List;

public class Songlist2Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Songlist2Adapter(List<SongModel> listitems, Activity context,int maxsize) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(ItemSong2Binding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false));
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        private ItemSong2Binding item;
        public MyViewHolder(ItemSong2Binding item) {
            super(item.getRoot());
            this.item = item;
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        Helper.displayImage(context,view.item.cover,songModel.getImage(),R.drawable.defaultimage);


        view.item.play.setOnClickListener(new View.OnClickListener() {
            @Override
